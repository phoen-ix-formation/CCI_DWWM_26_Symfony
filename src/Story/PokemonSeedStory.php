...
/**
 * Données de référence déterministes — safe en production.
 *
 * Dev  : symfony console foundry:load-fixtures main
 * Prod : symfony console foundry:load-fixtures seed --env=prod
 */
#[AsFixture(name: 'seed')]
final class PokemonSeedStory extends Story
{
